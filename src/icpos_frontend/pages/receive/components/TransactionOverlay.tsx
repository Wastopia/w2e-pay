...
import { useW2ELedgerAnon } from "../../../canisters/w2e-ledger/hooks/useW2ELedgerAnon";
...
export default function TransactionOverlay({
  ...
  const { ckBtcLedger } = useW2ELedgerAnon();
  ...
  return (
    <div className={classNames}>
      ...
      <div>{formatW2E(receivedTransfer?.amount)} W2E</div>
      <div className="grow" />
    </div>
  );
}
